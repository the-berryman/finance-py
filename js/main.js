 const chatBody = document.getElementById('chat-body');
        ...
        const questions = [
            ...
            "Great! Now, what is your annual income?",
        ...
        function processUserInput(input) {
            ...
            console.log(`User input for question ${currentQuestion}: ${input}`);  // Log user input

            // Store user response
            switch (currentQuestion) {
                case 0: userResponses.age = parseInt(input); break;
                case 1: userResponses.income = parseInt(input); break;
                case 2: userResponses.retirement_age = parseInt(input); break;
                case 3: userResponses.target_amt = parseInt(input); break;
                case 4:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    userResponses.spouse_income = parseInt(input);
                    calculateRetirement();
                    return;
            }
        ...
        function calculateRetirement() {
            ...
            console.log("Sending data to server:", userResponses);  // Log the data being sent
            ...
            .then(results => {
                console.log("Received results from server:", results);  // Log the received results
                if (results.error) {
